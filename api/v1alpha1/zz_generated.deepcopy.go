...
func (in *OSBuildsConfig) DeepCopyInto(out *OSBuildsConfig) {
	*out = *in
	...
	if in.TaskBundleCosignKeyRef != nil {
		in, out := &in.TaskBundleCosignKeyRef, &out.TaskBundleCosignKeyRef
...
func (in *WorkspacesConfig) DeepCopyInto(out *WorkspacesConfig) {
	*out = *in
	...
	if in.ImageCosignKeyRef != nil {
		in, out := &in.ImageCosignKeyRef, &out.ImageCosignKeyRef
		*out = new(corev1.ConfigMapKeySelector)
		(*in).DeepCopyInto(*out)
	}
}
